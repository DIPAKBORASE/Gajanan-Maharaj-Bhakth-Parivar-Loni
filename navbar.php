    ...
    <nav class="bg-white border-gray-200 dark:bg-gray-900">
        <div
            ...
            <a href=""
                ...
                <img
                    src="./imgs/GURU-logo.jpeg"
                    class="h-8" alt="Flowbite Logo" />
                <span
                    class="self-center text-gray-900 font-semibold whitespace-nowrap dark:text-white">श्री गजानन महाराज भक्त परिवार</span>
            ...
            <div class="hidden w-full md:block md:w-auto"
                ...
                <ul
                    ...
                    <li>
                        <a href="./index.php"
                            class="block py-2 px-3 text-white bg-blue-900 rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-white md:dark:text-blue-500"
                    ...
                    <li>
                        <a href="./documets.php"
                            class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Documents</a>
                    </li>
                    <!-- <li>
                                    <a href="#"
                    ...
                    <li>
                        <a href="#registerModal" data-modal-target="registerModal" data-modal-toggle="registerModal"
